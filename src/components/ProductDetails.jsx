...
<div class="grid max-w-[50%] gap-4">
    <div>
        <img class="w-[730px] h-[450px] contain-content  rounded-lg" src={item.image} alt=""/>
    </div>
    <div class="grid grid-cols-5  gap-4">
        <div>
            <img class="h-[100px] max-w-full contain-content rounded-lg" src={item.image} alt=""/>
        </div>
        <div>
            <img class="h-[100px] max-w-full rounded-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-2.jpg" alt=""/>
        </div>
        <div>
      ...
      <div className="max-w-[40%] md:w-1/2 px-4">
        ...
        <div className="mb-6">
          ...
          <h3 className="text-lg font-base mb-2">{item.whatsapp}</h3>
         
        </div>
         <div classNameName="flex justify-items-start gap-3 mt-2 px2">
                <IconWithFallback src="/marker.png" alt="Location" />

                <p classNameName="text-base font-medium text-gray-700">{item.area}, {item.tehsil}, {item.district}, {item.province}</p>
              </div>
          </div>
        </div>
